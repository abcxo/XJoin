...
- (NSString *)platform {
	const char *spec = "hw.machine";
	return [self getSysInfoByName:spec];
}
...
- (NSUInteger)platformType {
	...
	if ([platform hasPrefix:@"iPhone5,3"] || [platform hasPrefix:@"iPhone5,4"]) return UIDevice5CiPhone;
...
- (NSString *)modelString {
	...
	if ([platform hasPrefix:@"AppleTV"]) return APPLETV_UNKNOWN_NAMESTRING;
