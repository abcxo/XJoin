...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = NSLocalizedString(@"上拉可以加載更多",nil);
        self.releaseToRefreshText = NSLocalizedString(@"鬆開立即加載更多",nil);
        self.refreshingText = NSLocalizedString(@"正在加載更多...",nil);
    }
    return self;
}
