...
//	[self.view addSubview:rightBtn];
	...
	self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStylePlain target:self action:@selector(handleNavLeft:)];
	self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStylePlain target:self action:@selector(handleNavRight:)];

	NSArray *arr = [NSArray arrayWithObjects:@"原圖", @"LOMO", @"黑白", @"復古", @"哥特", @"銳色", @"淡雅", @"酒紅", @"青檸", @"浪漫", @"光暈", @"藍調", @"夢幻", @"夜色", nil];
